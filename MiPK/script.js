...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const operadoresButtonPlus = document.querySelector('.plus-option-button[aria-label="OPERADORES"]');
    ...
    if (operadoresButtonPlus) {
        operadoresButtonPlus.addEventListener('click', function() {
            document.getElementById('plus-card-container').style.display = 'none'; // Ocultar la tarjeta PLUS
            operadoresCardContainer.style.display = 'flex';
        });
    } else {
        console.error('No se encontró el botón OPERADORES');
    }
    
    if (cerrarOperadoresCardButton) {
        cerrarOperadoresCardButton.addEventListener('click', function() {
            operadoresCardContainer.style.display = 'none'; // Ocultar la tarjeta PLUS
            document.getElementById('plus-card-container').style.display = 'flex'; // Mostrar la tarjeta PLUS
        });
    } else {
        console.error('No se encontró el botón de cerrar de la tarjeta OPERADORES');
    }

    document.addEventListener('DOMContentLoaded', function() {

//CIRCULACION
const circulacionButton = document.querySelector('#operadores-plus-container button[aria-label="CIRCULACIÓN"]');

    if (circulacionButton) {
        circulacionButton.addEventListener('click', function() {
            document.getElementById('operadores-card-container').style.display = 'none';
            document.getElementById('circulacion-card-container').style.display = 'flex'; // Mostrar la tarjeta de operadores
            generarBotonesOperadores(); // Llama a la función para generar los botones
        });
    } else {
    ...
    //CPS
    const cpsButton = document.querySelector('#operadores-plus-container button[aria-label="CPS"]');
    if (cpsButton) {
        cpsButton.addEventListener('click', function() {
            document.getElementById('operadores-card-container').style.display = 'none';
            document.getElementById('cps-card-container').style.display = 'flex'; // Mostrar la tarjeta CPS
    ...
    //CSI
    const csiButton = document.querySelector('#operadores-plus-container button[aria-label="CSI"]');

    if (csiButton) {
        csiButton.addEventListener('click', function() {
            document.getElementById('operadores-card-container').style.display = 'none';
            document.getElementById('csi-card-container').style.display = 'flex'; // Mostrar la tarjeta CSI
    ...
    //TELEMANDO
    const telemandoButton = document.querySelector('#operadores-plus-container button[aria-label="TELEMANDO"]');

    if (telemandoButton) {
        telemandoButton.addEventListener('click', function() {
            document.getElementById('operadores-card-container').style.display = 'none';
            document.getElementById('telemando-card-container').style.display = 'flex'; // Mostrar la tarjeta TELEMANDO
